...
from custom_utils import create_result_df, get_max_4
...
def parse_args():
    ...
    parser.add_argument('--file_name', type=str, default='res.csv')
...
def main():
    ...
    if not distributed:
        ...
        my_test_df = create_result_df(outputs, test_df)
        #file_name = 'final_res.csv'
        #my_test_df.to_csv(file_name, index=False)
        get_max_4(my_test_df, args.file_name)
