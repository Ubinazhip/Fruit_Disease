...
data_root = '/data/ubingazhibov/dl_hw/project/'
...
lr_config = dict(warmup_iters=1000, step=[10, 13, 17])
runner = dict(type='EpochBasedRunner', max_epochs=20)
fp16 = dict(loss_scale=512.)
log_config = dict(interval=1200)
resume_from = '/data/ubingazhibov/dl_hw/project/work_dir1/universnet/fold4/epoch_14.pth'
#load_from="/data/ubingazhibov/dl_hw/project/load_models/universenet101_2008d_fp16_4x4_mstrain_480_960_20e_coco_20201023_epoch_20-3e0d236a.pth"
work_dir=f"/data/ubingazhibov/dl_hw/project/work_dir1/universnet/fold{fold}_resume"
